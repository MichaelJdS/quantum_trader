...
start "Quantum Trader - Motor AI" cmd /c ".venv\Scripts\python.exe -m uvicorn cloud_api.main:app --host 0.0.0.0 --port 8080 --ws-ping-interval 20 --ws-ping-timeout 30"
